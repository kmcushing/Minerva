# GENERATED BY ChatGPT with slight modifications for output style
# and additional classes due to html formatting and typos
import requests
...
#     course_texts = [
#         courseblock.get_text(separator=" ", strip=True) for courseblock in courseblocks
#     ]
#     return course_texts
...
def main():
    ...
    # f = open("data/course_listings.txt", "w")
    # Output the collected course information
    for title, description, extra_info in all_courses_info:
        # print("Title:", course_info['title'])
        # print("Description:", course_info['description'])
        # print("Extra:", course_info['extra'])
        # print('-' * 80)
        # f.write(f"Title: {course_info['title']}")
        # f.write("\n")
        # f.write(f"Description: {course_info['description']}")
        # f.write("\n")
        # f.write(f"Extra: {course_info['extra']}")
        # f.write("\n")
        # f.write("-" * 80)
        # f.write("\n")
